              ...
              {userOrders.map(order => {
                return (
                  <div 
                    key={order.id} 
                    id={order.id} 
                    className="col-12 col-md-6 col-lg-4 d-flex flex-column mb-20">
                      <div className="bg-light rounded px-3 py-3">
                        ...
                        <p className="order-details mb-10">
                          {FormatDate(order.created_at)}
                        </p>
                        <p>
                          Liked the restaurant?
                          <a className="btn btn-view-menu text-decoration-underline py-0 mx-2" role="button" href={`/restaurant/${order.restaurant.id}`}>
                            Order again
                          </a>
                        </p>
