          ...
          <div className="pl-40 pr-40">
            ...
            <div className="pb-40">
              ...
              <button className="btn btn-danger mt-20" value='Pizza' onClick={this.handleClick}>
                ...
                <button className="position-relative btn-category-filter" value="All" onClick={this.handleClick}>
                ...
                <button className="position-relative btn-category-filter" value="Burger" onClick={this.handleClick}>
                <span className="fa-layers fa-fw fa-5x">
                    <FontAwesomeIcon icon={faSquare} className="category-square" />
                ...
                <button className="position-relative btn-category-filter" value="Pizza" onClick={this.handleClick}>
                <span className="fa-layers fa-fw fa-5x">
                    <FontAwesomeIcon icon={faSquare} className="category-square" />
