      ...
      <div className="pl-40 pr-40">
        <div className="row">
          <div className="col-6 col-lg-4">
            ...
            <a href="/login" className="text-decoration-underline">Sign up or log in and start ordering</a>
          </div>
          <div className="col-6 col-lg-4">
          ...
          <div className="col-6 col-lg-4">
            ...
            <a href="/delivery/login" className="text-decoration-underline">Sign up to deliver</a>
          </div>
        </div>
      </div>
    </div>
