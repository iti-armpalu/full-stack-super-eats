...
class BusinessLoginWidget extends React.Component {
  state = {
    email: '',
    password: '',
    error: '',
    ...
    return (
      <React.Fragment>
        <div className="text-center mb-40">
          <h2>Log in</h2>
          <p>Just log in to your business account and see what people have ordered.</p>
        </div>
        ...
        <p className="text-center mt-40 mb-20">Don't have a business account yet? 
...
export default BusinessLoginWidget